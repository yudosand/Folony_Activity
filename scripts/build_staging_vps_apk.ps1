param(
    [string]$BackendBaseUrl = "https://staging-absent.folony.co.id/api"
)
...
$outputApk = Join-Path $distRoot 'FolonyActivity-staging-vps-arm64-release.apk'
...
Write-Host "Building Folony Activity staging VPS APK"
